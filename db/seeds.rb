...
teacher_two = User.create!(email: "teacher3@fount.io", password: "teacher123", first_name: "Tim", last_name: "Teacher")
teacher_three = User.create!(email: "teacher2@fount.io", password: "teacher123", first_name: "John", last_name: "Teacher")
